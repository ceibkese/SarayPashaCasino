(function () {
  ...
  function enhanceProviderShortcuts(){
    ...
    root.innerHTML=
      '<a class="sp-provider-shortcut sp-provider-pragmatic" href="/'+language+'/casino?provider=pragmatic-play"><span class="sp-provider-shortcut-name">Pragmatic Play</span><span class="sp-provider-shortcut-action"><b class="sp-provider-shortcut-arrow">➜</b>Hemen Oyna!</span></a>'+
      '<a class="sp-provider-shortcut sp-provider-egt" href="/'+language+'/casino?provider=egt-digital"><span class="sp-provider-shortcut-name">EGT Digital Bell Link</span><span class="sp-provider-shortcut-action"><b class="sp-provider-shortcut-arrow">➜</b>Hemen Oyna!</span></a>'+
      '<a class="sp-provider-shortcut sp-provider-amusnet" href="/'+language+'/casino?provider=amusnet"><span class="sp-provider-shortcut-name">Amusnet (EGT)</span><span class="sp-provider-shortcut-action"><b class="sp-provider-shortcut-arrow">➜</b>Hemen Oyna!</span></a>';
    banner.insertAdjacentElement("afterend",root);
  }

  function refresh(){ enhance(); enhanceAllTransactionInputs(); enhanceBonusRequestPage(); enhanceQuickActions(); enhanceProviderShortcuts(); continuePendingAction(); }
