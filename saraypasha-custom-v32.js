(function () {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:768px){
        ...
        .sp-provider-shortcuts{width:calc(100% - 24px)!important;margin:5px auto 18px!important;gap:7px!important}
        ...
        .sp-banner-dots{display:flex!important;align-items:center!important;justify-content:center!important;gap:11px!important;width:100%!important;height:18px!important;margin:-43px 0 0!important;padding:0!important}
        .sp-banner-dot{display:block!important;width:7px!important;height:7px!important;margin:0!important;padding:0!important;border:0!important;border-radius:50%!important;background:rgba(111,127,48,.38)!important;box-shadow:none!important;transition:transform .18s ease,background .18s ease!important}
        .sp-banner-dot.sp-banner-dot-active{width:9px!important;height:9px!important;background:#e5ca6b!important;transform:none!important;box-shadow:0 0 7px rgba(229,202,107,.28)!important}
      }
    `;
  ...
  function enhanceAnnouncementBar(){
    var line=document.querySelector('[data-mj="announcement"] p');
    if(!line) return;
