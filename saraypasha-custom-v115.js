(function () {
  ...
  function isStrictWithdrawalFormReady(paymentId){
    if(["113","410"].indexOf(paymentId)===-1) return true;
    ...
    return Array.prototype.slice.call(document.querySelectorAll("form")).some(function(form){
      ...
      var text=normalizeTurkish(form.textContent||"");
      return !!amount&&!!iban&&!!bankSelect&&text.indexOf("IBAN")!==-1&&
        text.indexOf("BANKA")!==-1&&text.indexOf("KILITLI BAKIYE")!==-1;
    });
  }
  ...
  function beginWithdrawalMethodSwitch(event){
    ...
    var paymentId=(source.match(/\/payments\/(\d+)/)||[])[1]||"";
    if(["113","410"].indexOf(paymentId)===-1) return;
