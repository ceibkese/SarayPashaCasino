(function () {
  ...
  function isWithdrawalMethodFormReady(paymentId,targetForm){
    ...
    return forms.some(function(form){
      ...
      var dialog=form.closest('[role="alertdialog"]');
      var dialogText=normalizeTurkish((dialog&&dialog.textContent)||form.textContent||"");
      if(dialogText.indexOf("MIN")===-1||dialogText.indexOf("MAKS")===-1) return false;
