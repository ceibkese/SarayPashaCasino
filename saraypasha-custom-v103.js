    ...
    input.addEventListener("focus",function(){
      ...
      if(isStrictWithdrawalAmountInput(input)){
        ...
        [0,70,150,260,420,650].forEach(function(delay){
          setTimeout(function(){revealWithdrawalAmountInput(input);},delay);
        });
        /* Klavye ve Safari gorunur alani oturduktan sonra, yeni dogru konumu
           IBAN alanindaki gibi kilitle; kullanici formu asagi surukleyemesin. */
        setTimeout(function(){
          if(document.activeElement===input&&isStrictWithdrawalAmountInput(input)){
