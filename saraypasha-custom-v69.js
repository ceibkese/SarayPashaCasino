(function () {
  ...
  function syncSportsIframeHeight(){
    ...
    var available=Math.max(320,Math.floor(navTop-frameTop));
  ...
  function refresh(){ syncPageMode(); syncSportsIframeHeight(); enhanceBankTransfer(); enhance(); enhanceAllTransactionInputs(); enhanceBonusRequestPage(); enhanceQuickActions(); enhanceProviderShortcuts(); enhanceBannerDots(); enhanceAnnouncementBar(); watchWithdrawalPanel(); watchDepositPanel(); continuePendingAction(); }
