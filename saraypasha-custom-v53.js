(function () {
  ...
  function placeBankPortal(form,panel){
    ...
    requestAnimationFrame(function(){
      ...
      form.style.setProperty("--sp-bank-panel-space",Math.ceil(panel.getBoundingClientRect().height+16)+"px");
    });
  }
  ...
  function enhanceBankTransfer(){
    ...
    Array.prototype.slice.call(document.querySelectorAll("form")).forEach(function(form){
      ...
      if(formText.indexOf("MANUAL HAVALE")===-1&&formText.indexOf("HEMEN HAVALE")===-1&&formText.indexOf("BANK TRANSFER")===-1&&formText.indexOf("BANKA HAVALESI")===-1) return;
      ...
      Array.prototype.slice.call(form.querySelectorAll("p,span,div")).forEach(function(element){
        ...
        if(nativeTitle==="MANUAL HAVALE"||nativeTitle==="HEMEN HAVALE") element.classList.add("sp-bank-native-title");
      });
