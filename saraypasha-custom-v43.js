(function () {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      body.sp-casino-page main{min-height:calc(100dvh - 190px)!important;box-sizing:border-box!important}
      @media(max-width:768px){body.sp-casino-page main{min-height:calc(100dvh - 185px)!important}}
      @media(max-width:768px){
  ...
  function syncPageMode(){
    ...
    var casino=/^\/(tr|en)\/casino(?:\/|$)/i.test(window.location.pathname);
    document.body.classList.toggle("sp-home-page",home);
    document.body.classList.toggle("sp-sports-page",sports);
    document.body.classList.toggle("sp-casino-page",casino);
  ...
  function refresh(){ syncPageMode(); enhance(); enhanceAllTransactionInputs(); enhanceBonusRequestPage(); enhanceQuickActions(); enhanceProviderShortcuts(); enhanceBannerDots(); enhanceAnnouncementBar(); watchWithdrawalPanel(); continuePendingAction(); }
