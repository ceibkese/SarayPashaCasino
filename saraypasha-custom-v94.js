(function () {
  ...
  function syncMobilePaymentBrand(form){
    ...
    if(["113","114","277"].indexOf(paymentId)===-1){
      if(existing) existing.remove();
      form.removeAttribute("data-sp-payment-brand");
      return;
    }
  ...
  listenGlobal(window,"resize",function(){syncSportsIframeHeight();enhanceDepositFrames();});
  listenGlobal(window,"orientationchange",function(){setTimeout(function(){syncSportsIframeHeight();enhanceDepositFrames();},160);});
