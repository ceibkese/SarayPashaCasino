(function () {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:768px){
        ...
        .sp-provider-shortcuts{width:calc(100% - 40px)!important;margin:12px auto 18px!important;gap:8px!important}
        .sp-provider-shortcut{display:block!important;min-height:0!important;height:auto!important;padding:0!important;overflow:hidden!important;border:0!important;border-radius:6px!important;background:none!important;clip-path:none!important;box-shadow:0 7px 18px rgba(0,0,0,.24)!important}
        .sp-provider-shortcut:before{display:none!important}
  ...
  function isHomePage(){
    return /^\/(tr|en)\/?$/i.test(window.location.pathname);
  }

  function syncPageMode(){
    if(!document.body) return;
    document.body.classList.toggle("sp-home-page",isHomePage());
  }
