(function () {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:768px){
        ...
        .sp-provider-shortcut{display:block!important;min-height:0!important;height:auto!important;padding:0!important;overflow:hidden!important;border:0!important;border-radius:0!important;background:none!important;clip-path:polygon(13px 0,100% 0,100% 100%,13px 100%,0 50%)!important;box-shadow:0 7px 18px rgba(0,0,0,.24)!important}
  ...
  function refresh(){ enhance(); enhanceAllTransactionInputs(); enhanceBonusRequestPage(); enhanceQuickActions(); enhanceProviderShortcuts(); enhanceBannerDots(); continuePendingAction(); }
